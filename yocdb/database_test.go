...
func newTestLDB() (*yocdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "yocdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := yocdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db yocdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db yocdb.Database, t *testing.T) {
	const n = 8
