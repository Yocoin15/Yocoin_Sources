...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db yocdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db yocdb.Database) error {
