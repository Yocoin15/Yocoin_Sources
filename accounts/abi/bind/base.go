...
type TransactOpts struct {
	From   common.Address // YOC account to send the transaction from
...
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the YOC blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct YOC methods
