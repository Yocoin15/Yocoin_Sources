...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage YoCoin presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    yocoin wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import YoCoin presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	yocoin wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    yocoin account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    yocoin account import [options] <keyfile>
