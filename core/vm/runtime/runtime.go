...
// It returns the YVM's return value, the new state and an error if it failed.
//
...
// Create executes the code using the YVM create method
...
// YVM's return value or an error if it failed.
//
