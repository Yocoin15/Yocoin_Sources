...
// NewYVMContext creates a new context for use in the YVM.
func NewYVMContext(msg Message, header *types.Header, chain ChainContext, author *common.Address) vm.Context {
