...
func makeTestState() (Database, *yocdb.MemDatabase, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db yocdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db yocdb.Database, root common.Hash) error {
...
func checkStateConsistency(db yocdb.Database, root common.Hash) error {
