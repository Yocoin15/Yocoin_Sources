...
// Package state provides a caching layer atop the YOC state trie.
package state
...
//
// CreateAccount is called during the YVM CREATE operation. The situation might arise that
...
// used when the YVM emits new state logs.
